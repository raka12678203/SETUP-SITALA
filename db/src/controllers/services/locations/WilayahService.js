...
class WilayahService {
	constructor() {
		this._Repository = new Repository(GetDataModel, "Wilayahs");
	...
	async CreateData(req, res) {
		return new Promise(async (resolve, reject) => {
			...
			if (await $checkingWilayahs(req, roleDatas)) {
	...
	async UpdateDataByID(req, res) {
		return new Promise(async (resolve, reject) => {
			...
			const roleDatas = await this._Repository.GetTempDatas();
			if (!(await $checkingWilayahs({ id }, roleDatas))) {
