...
class BatasWilayahService {
	constructor() {
		this._Repository = new Repository(GetDataModel, "BatasWilayahs");
	...
	async CreateData(req, res) {
		return new Promise(async (resolve, reject) => {
			...
			if (await $checkingBatasWilayahs(req, roleDatas)) {
	...
	async UpdateDataByID(req, res) {
		return new Promise(async (resolve, reject) => {
			...
			const roleDatas = await this._Repository.GetTempDatas();
			if (!(await $checkingBatasWilayahs({ id }, roleDatas))) {
...
module.exports = BatasWilayahService;
