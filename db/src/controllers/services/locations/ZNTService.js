...
class ZNTService {
	constructor() {
		this._Repository = new Repository(GetDataModel, "ZNTs");
	...
	async CreateData(req, res) {
		return new Promise(async (resolve, reject) => {
			...
			if (await $checkingZNTs(req, roleDatas)) {
	...
	async UpdateDataByID(req, res) {
		return new Promise(async (resolve, reject) => {
			...
			const roleDatas = await this._Repository.GetTempDatas();
			if (!(await $checkingZNTs({ id }, roleDatas))) {
