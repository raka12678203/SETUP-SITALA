...
class PolaRuangService {
	constructor() {
		this._Repository = new Repository(GetDataModel, "PolaRuangs");
	...
	async CreateData(req, res) {
		return new Promise(async (resolve, reject) => {
			...
			if (await $checkingPolaRuangs(req, roleDatas)) {
	...
	async UpdateDataByID(req, res) {
		return new Promise(async (resolve, reject) => {
			...
			const roleDatas = await this._Repository.GetTempDatas();
			if (!(await $checkingPolaRuangs({ id }, roleDatas))) {
...
module.exports = PolaRuangService;
